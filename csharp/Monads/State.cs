...
namespace Monads
{
	...
	{
		// This monad models a stateful computation, in a mutable environment. Not super useful in
		// nonpure imperative languages, since everything by default is already a stateful 
		// computation in a mutable environment, but it's still interesting. Good to know it exists.
		...
		// A stateful operation that replaces the current state with the given state.
